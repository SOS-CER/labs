...
#### Alternative Flows
  ...
  * <a id="uc10-invalidenrollmentcap"></a>**[Invalid Enrollment Capacity]**: <font color="red">If the course's enrollment capacity is invalid</font> **[[Invalid Course Records]](#invalid-course-records)**, <font color="red">the error message "Invalid enrollment cap" is displayed.  The user clicks OK and is returned to the course catalog display.</font>
