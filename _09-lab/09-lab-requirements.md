...
description: CSC 217 Lab 09 - Requirements
navigation: on
pagegroup: 09-lab
---

# CSC 217 Lab 09 Requirements
...
<font color="red">For Lab 09, you will add a waitlist to the course roll, which is described in </font>[[UC8]](#uc8), [[UC10]](#uc10), [[UC14]](#uc14), <font color="red">and </font>[[UC15]](#uc15)<font color="red">.</font>
...
#### Main Flow
  ...
  5. <font color="red">All courses have a waitlist of size 10.</font>  
...
#### Main Flow
  ...
  3. <font color="red">All courses have a waitlist of size 10.</font>
...
#### Alternative Flows
  ...
  * <a id="uc14-a4"></a> **[Course Full]**: If the course is full (meaning the course has reached capacity <font color="red">and the waitlist has no more spots</font>), a pop-up message stating "The course cannot be added" is displayed. The student clicks OK and is returned to their schedule with no change.
...
#### Main Flow
  ...
  5. <font color="red">If there is a student on the waitlist, the student who joined the waitlist first is removed from the waitlist and is enrolled in the course </font> [[UC14]](#uc14).
